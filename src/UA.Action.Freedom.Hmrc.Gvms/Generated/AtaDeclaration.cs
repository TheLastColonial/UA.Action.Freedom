...
namespace UA.Action.Freedom.Hmrc.Gvms
{
    ...
    public partial class AtaDeclaration
    {

        /// <summary>
        /// The ATA Carnet ID for the carnet within an ATA goods movement
        /// </summary>
        [System.Text.Json.Serialization.JsonPropertyName("ataCarnetId")]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [System.ComponentModel.DataAnnotations.RegularExpression(@"^.{1,200}$")]
        public string AtaCarnetId { get; set; } = default!;
