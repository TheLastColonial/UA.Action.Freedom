...
namespace UA.Action.Freedom.Hmrc.Gvms
{
    ...
    public partial class Link2
    {
        ...
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [System.Text.Json.Serialization.JsonConverter(typeof(System.Text.Json.Serialization.JsonStringEnumConverter<Method2>))]
        public Method2 Method { get; set; } = default!;

        [System.Text.Json.Serialization.JsonPropertyName("rel")]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [System.Text.Json.Serialization.JsonConverter(typeof(System.Text.Json.Serialization.JsonStringEnumConverter<Rel2>))]
        public Rel2 Rel { get; set; } = default!;
