...
namespace UA.Action.Freedom.Hmrc.Gvms
{
    ...
    public partial class PlannedCrossing
    {
        ...
        /// </summary>
        [System.Text.Json.Serialization.JsonPropertyName("localDateTimeOfDeparture")]
        [System.ComponentModel.DataAnnotations.RegularExpression(@"^\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d$")]
        public string? LocalDateTimeOfDeparture { get; set; } = default!;
