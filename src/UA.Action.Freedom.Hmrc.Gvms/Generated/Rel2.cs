...
namespace UA.Action.Freedom.Hmrc.Gvms
{
    ...
    public enum Rel2
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"update-goods-movement-record")]
        UpdateGoodsMovementRecord = 0,

        [System.Runtime.Serialization.EnumMember(Value = @"delete-goods-movement-record")]
        DeleteGoodsMovementRecord = 1,
