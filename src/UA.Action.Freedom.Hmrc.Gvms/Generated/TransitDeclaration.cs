...
namespace UA.Action.Freedom.Hmrc.Gvms
{
    ...
    public partial class TransitDeclaration
    {

        /// <summary>
        /// This is the Transit MRN issued by the Office of Departure.  Must be provided.
        /// </summary>
        [System.Text.Json.Serialization.JsonPropertyName("transitDeclarationId")]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [System.ComponentModel.DataAnnotations.RegularExpression(@"^\d{2}[A-Z]{2}[A-Z0-9]{14}$")]
        public string TransitDeclarationId { get; set; } = default!;

        /// <summary>
        /// Set to true if the transit declaration is a TSAD, otherwise set to false (for a TAD)
        /// </summary>
        [System.Text.Json.Serialization.JsonPropertyName("isTSAD")]
        public bool IsTSAD { get; set; } = default!;
