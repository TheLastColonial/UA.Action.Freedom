...
internal static class VehicleTestData
{
    ...
    internal static RecordInspectionCommand ARecordInspectionCommand(
        string vin = "WVWZZZ1JZXW000001",
        InspectionStatus status = InspectionStatus.Passed,
        string? notes = "Brakes and tyres checked") => new(vin, status, notes);
